    ...
    return (
        <div className="relative">
            <button
                ...
                className="absolute top-2 right-4 bg-white border rounded-full shadow-md p-2 z-20 hover:bg-gray-100 transition duration-300"
            >
            ...
            {openCart && (
                <div className="absolute top-12 right-4 bg-white border rounded-md shadow-md p-4 z-10 w-80">
